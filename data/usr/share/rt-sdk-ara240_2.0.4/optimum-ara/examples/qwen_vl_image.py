...
# Configuration
IMAGE_PATH = "/home/shayan/demo.jpeg"
PROMPT = "Describe this image briefly"
MODEL_PATH = (
    "/home/shayan/alder_work/kau_optimum_ara/kau/optimum-ara/models/qwen2.5-image-3B"
)
...
processed_inputs = cast(Qwen2_5_VLProcessor, processor)(
    ...
    videos=cast(List[Any], video_inputs if video_inputs else []),
    padding=True,
    return_tensors="pt",
)
